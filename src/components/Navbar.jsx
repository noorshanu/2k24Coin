...
function Navbar() {
  ...
  return (
    <>
      <nav className="z-[100] bg-[#d7bc7a] lg:bg-transparent ">
        <div className="container-wrapper border-none sm:border-2 border-[#fff] bg-[#f0c455] h-14 lg:h-16 2xl:h-20 rounded-2xl flex justify-between lg:justify-normal lg:grid lg:grid-cols-[1fr_16rem_1fr] gap-8 items-center">
          ...
          <div>
            <img
              src="/images/logo.png"
              className="h-[70px] sm:h-[85px] w-auto mx-auto"
              alt=""
            />
          </div>
